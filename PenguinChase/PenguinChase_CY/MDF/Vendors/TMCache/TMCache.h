...
//add by xiejinzhan
typedef void (^TMCacheExistObjectBlock)(TMCache *cache,BOOL exist);
typedef NSUInteger (^TMCacheCostForSetObjectBlock)(TMCache *cache, NSString *key, id object);
...
@property (nonatomic, copy) TMCacheCostForSetObjectBlock costBlock; // setObject:block方法使用，用于自动计算cost
 ...
 */
- (void)setObject:(id )object forKey:(NSString *)key block:(TMCacheObjectBlock)block;
