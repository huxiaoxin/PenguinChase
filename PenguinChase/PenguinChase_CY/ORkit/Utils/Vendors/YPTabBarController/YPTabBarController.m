...
- (void)setupFrameOfTabBarAndContentView {
    ...
    CGSize screenSize_YP = [UIScreen mainScreen].bounds.size;
    
    CGFloat contentViewY = 0;
    CGFloat tabBarY = screenSize_YP.height - TAB_BAR_HEIGHT;
    ...
    if ([self.parentViewController isKindOfClass:[UINavigationController class]] &&
        ...
        if (!self.navigationController.navigationBar.translucent ||
            ...
            tabBarY = screenSize_YP.height - TAB_BAR_HEIGHT - navMaxY;
            contentViewHeight = tabBarY;
        } else {
            contentViewY = navMaxY;
            contentViewHeight = screenSize_YP.height - TAB_BAR_HEIGHT - contentViewY;
        }
    }
    
    [self setTabBarFrame:CGRectMake(0, tabBarY, screenSize_YP.width, TAB_BAR_HEIGHT)
        contentViewFrame:CGRectMake(0, contentViewY, screenSize_YP.width, contentViewHeight)];
}
