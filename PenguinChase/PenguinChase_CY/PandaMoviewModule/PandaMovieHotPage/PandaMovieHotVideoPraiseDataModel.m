//
//  PandaMovieHotVideoPraiseDataModel.m
//
//
...
@implementation PandaMovieHotVideoPraiseDataModel
...
- (BOOL)PandaMovieaddPraiseWithType:(NSString *)videoId Pandatype:(NSString *)type
{
    if (self.isLoading) {
        return NO;
    }
