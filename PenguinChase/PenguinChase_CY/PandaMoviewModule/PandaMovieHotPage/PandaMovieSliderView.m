...
@interface PandaMovieSliderView()
...
@implementation PandaMovieSliderView
...
- (void)showLineLoading {
    [PandaMovieLineLoadingView PandaMovieshowLoadingInView:self withLineHeight:self.gk_height];
}

- (void)hideLineLoading {
    [PandaMovieLineLoadingView hideLoadingInView:self];
}
