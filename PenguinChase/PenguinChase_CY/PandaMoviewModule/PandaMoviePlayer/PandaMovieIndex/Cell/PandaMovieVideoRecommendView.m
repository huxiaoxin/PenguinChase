...
@interface PandaMovieVideoRecommendView ()
...
@implementation PandaMovieVideoRecommendView
...
- (void)setupUIs
{
    ...
    // 影视名称
    UILabel *PandaMovienameLabel = [UILabel ly_LabelWithTitle:@"" font:zy_mediumSystemFont14 titleColor:gnh_color_r];
