...
@interface PengUinChaseWatchedViewController ()<PenguinChaseHomeTableViewCellDelegate>
...
-(void)PenguinChaseHomeTableViewCellWithWantbtnAction:(NSInteger)btnIndex{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [self.PenguinChaseTableView reloadData];
        [WHC_ModelSqlite update:[PenguinChaseVideoModel class] value:[NSString stringWithFormat:@"isViews ='%@'",@(pengModel.isViews)] where:[NSString stringWithFormat:@"penguinChase_MoviewID = '%ld'",pengModel.penguinChase_MoviewID]];
    });
}
